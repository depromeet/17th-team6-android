...
import com.dpm.sixpack.data.source.local.database.dao.CourseWithLocations
import com.dpm.sixpack.data.source.local.database.dao.RunSessionWithCourseAndLocations
...
@Singleton
class LocalRunningDataSource @Inject constructor(private val runningDao: RunningDao) {
    /**
    ...
    fun getLocationsWithCourse(courseId: Long): Flow<CourseWithLocations> =
        runningDao.getLocationWithCourse(
            courseId,
        )

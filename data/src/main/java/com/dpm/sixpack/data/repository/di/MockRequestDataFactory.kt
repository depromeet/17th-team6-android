        ...
        val mockSegments =
            listOf(
                ...
                LocationDataRequestDto(
                    ...
                    pace = 300, // 5'00"/km
                    cadence = 175,
                    distance = 1500, // 누적 1.5km
                    time = "2025-09-14T03:04:30Z",
                ),
            )
        return SaveSegmentDataRequestsDto(segment = mockSegments, isStopped = false, isEnded = false)
    }
}

...
constructor(
    ...
    operator fun invoke(): Flow<DoRunResult<RealtimeRunningData>> {
        ...
        val distanceAccumulatorFlow: Flow<Pair<Location?, Float>> = gpsRepository.getLocationFlow()
            .scan(Pair<Location?, Float>(null, 0f)) { accumulator, locationResult ->
                ...
                val newTotalDistance = if (lastLocation != null) {
        ...
        return combine(
            ...
            val realtimeData = RealtimeRunningData(

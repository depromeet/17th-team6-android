...
class GetFeedsByDateUseCase @Inject constructor(
    ...
    // ------------------------
    private val mockRunningResult1 =
    ...
    private val mockRunningResult2 =
        RunningSessionResult(
    ...
    private val mockRunningResult3 =
        RunningSessionResult(
    ...
    // Mock Reactions
    // ------------------------
    private val mockReactingUser1 =
        ReactingUser(
            user = mockUser2,
            reactedAt = "2025-11-02T10:30:00Z",
        )

    private val mockReactingUser2 =
        ReactingUser(
            user = mockUser3,
            reactedAt = "2025-11-02T10:35:00Z",
        )

    private val mockReaction1 =
        Reaction(
            emojiType = "THUMBS_UP",
            totalCount = 2,
            isReacted = false,

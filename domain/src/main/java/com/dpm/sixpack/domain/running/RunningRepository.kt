...
interface RunningRepository {
    ...
    fun addLocationToCourse(courseId: Long, simpleLocation: SimpleLocation, timestamp: Long)
    fun updateCourseDistance(courseId: Long, distance: Double)
    fun saveRunSession(courseId: Long, startTime: Long, endTime: Long)

...
// import com.dpm.sixpack.presentation.routes.running.map.friendsheet.contract.MarkerInfo
...
//    val markersInfo = mutableListOf<MarkerInfo>()
//
...
// //                .onSuccess { result ->
// //                    postSideEffect(MapSideEffect.FriendSheetSideEffect.ShowToast(R.string.friend_awake_toast, result))
// //                    refresh()
// //                }.onError { e ->

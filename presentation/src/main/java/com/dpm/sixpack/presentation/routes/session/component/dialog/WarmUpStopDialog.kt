...
@Composable
internal fun WarmUpStopDialog(
    onCancelClick: () -> Unit,
    onStopConfirmClick: () -> Unit,
) {
    RunningDialog(
        onDismissRequest = {},
        title = stringResource(R.string.dialog_warmup_stop_title),
        contentText = stringResource(R.string.dialog_warmup_stop_content),
...
@Preview
@Composable
private fun WarmUpStopDialogPreview() {
    WarmUpStopDialog(
        onCancelClick = {},
        onStopConfirmClick = {},
    )
